...
A key design feature runs through the whole analysis: **who draws the map**. All four Commonwealth single-member-district countries moved, over the twentieth century, from redistricting under direct **political control** to **independent commissions** — a natural before/after comparison the project exploits throughout.
...
Under political control, governments delay correcting their *own* over-represented seats longer than they delay correcting the opposition's. It is the one robust partisan fingerprint we find — and it disappears entirely once redistricting is handed to independent commissions.
:::
...
This is now a working paper — *"Historical Malapportionment and Elite Redistricting Strategies"* — coauthored by Marc Guinjoan, Carles Boix and Pablo Beramendi. See it on the [Papers](papers.qmd) page.
